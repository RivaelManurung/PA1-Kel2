...
<header id="header" class="fixed-top header-inner-pages">
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <h1 class="logo"><a href="index.html">SITANI</a></h1>
                    ...
                    <ul>
                        <li class="nav-item dropdown">
                            ...
                            @if (Auth::user()->hasRole('petani'))
                                <a href="{{ url('/dashboard') }}" class="nav-link nav-icon" href="#"
                                    data-bs-toggle="dropdown">
                                    <i class="bi bi-bell"></i>
                                <span class="badge warning"
                                    id="notificationCount">{{ session('notificationCount', 0) }}</span>
                                </a>
                            @endif
                            ...
                            @if (Auth::user())
                                <a class="dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="40"
                                        ...
                                        <path
                                            d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0zm-1 2a1 1 0 1 0-2 0 1 1 0 0 0 2 0z" />
